...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <motion.a
        href="/"
        className="absolute top-6 left-1/2 z-20 -translate-x-1/2 text-2xl font-black tracking-tighter md:top-8 md:text-3xl"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: [0.25, 0.4, 0.25, 1] }}
        whileHover={{ scale: 1.05 }}
      >
        <span className="text-[#121212]">Turbo</span>
        <motion.span
          className="text-[#AFFF00]"
          animate={{
            textShadow: [
              "0 0 10px rgba(175,255,0,0.35)",
              "0 0 22px rgba(175,255,0,0.7)",
              "0 0 10px rgba(175,255,0,0.35)",
            ],
          }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-12">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            >
              ...
              />
              PLATAFORMA SAAS PARA CRESCER MAIS RAPIDO
            </motion.div>
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              <motion.p
                ...
                animate="visible"
                custom={3}
                className="max-w-md pt-2 text-lg font-medium tracking-tight text-[#121212]/60 md:text-xl"
              >
                Automatize operacoes, acompanhe metricas e transforme visitantes em clientes com menos friccao.
              </motion.p>
            </div>
            ...
            >
              <motion.button
                className="bg-[#121212] text-white px-6 py-3 rounded-full font-bold text-sm tracking-wide flex items-center gap-2 group relative overflow-hidden shadow-[0_0_30px_rgba(18,18,18,0.18)]"
              ...
              >
                ...
                />
                <span className="relative z-10">Quero criar meu sistema</span>
                <motion.svg
            ...
            >
              {["Automacao", "Metricas ao vivo", "Onboarding rapido", "Suporte premium"].map((benefit, i) => (
                <motion.div
                  key={benefit}
                  className="flex items-center gap-2 text-xs font-medium text-[#121212]/60"
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              ...
              <img
                src="/bg01.png"
                alt="TurboSaaS platform preview"
                width={560}
                height={720}
                className="relative z-10 w-[420px] max-w-[92vw] drop-shadow-2xl md:w-[560px] lg:w-[640px]"
              />
            </motion.div>
          </motion.div>
        </div>
        ...
        <motion.div
          className="absolute bottom-2 left-1/2 -translate-x-1/2 md:bottom-[-40px]"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
