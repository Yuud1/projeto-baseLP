...
const instagramPosts = [
  { image: "/placeholder.svg?height=400&width=400&query=saas founder dashboard office", likes: "2.4k" },
  { image: "/placeholder.svg?height=400&width=400&query=startup team analytics screen", likes: "1.8k" },
  { image: "/placeholder.svg?height=400&width=400&query=product launch workspace neon", likes: "3.2k" },
  { image: "/placeholder.svg?height=400&width=400&query=developer building saas laptop", likes: "956" },
  { image: "/placeholder.svg?height=400&width=400&query=sales team pipeline meeting", likes: "1.5k" },
  { image: "/placeholder.svg?height=400&width=400&query=automation dashboard metrics", likes: "2.1k" },
]
  ...
  return (
    <section id="creators" className="relative py-16 bg-[#121212] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.a
            href="https://instagram.com/turbosaas"
            target="_blank"
          ...
          >
            ...
            <span className="relative z-10">Seguir @turbosaas</span>
          </motion.a>
        </motion.div>
      </div>
    </section>
