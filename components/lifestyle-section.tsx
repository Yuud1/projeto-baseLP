...
const socialPosts = [
  { handle: "@founderbia", text: "TurboSaaS tirou nosso onboarding do caos em uma semana.", likes: "2.4k" },
  { handle: "@growthleo", text: "Finalmente um painel que o time inteiro entende.", likes: "1.8k" },
  { handle: "@ops_mari", text: "Automacoes rodando sem depender de planilha e gambiarra.", likes: "956" },
]
